...
//        List<Student> students1 = students.hello.stream().collect(toList());
//        students1.forEach(System.out::println);
//        System.out.println("--------------");
//        System.out.println(students.hello.stream().collect(counting()));
//        System.out.println(students.hello.stream().count());
//        students.hello.stream().collect(
//                minBy(Comparator.comparingInt(Student::getScore)))
//                .ifPresent(System.out::println);
//        students.hello.stream().collect(
//                maxBy(Comparator.comparingInt(Student::getScore))
//        ).ifPresent(System.out::println);
//        System.out.println(students.hello.stream().collect(
...
//        ));
//
//        System.out.println(students.hello.stream().map(Student::getName)
//                .collect(joining()));
//        System.out.println(students.hello.stream().map(Student::getName)
//                .collect(joining(",")));
//        System.out.println(students.hello.stream().map(Student::getName)
